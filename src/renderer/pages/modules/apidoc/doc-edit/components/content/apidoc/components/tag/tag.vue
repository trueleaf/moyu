            ...
            <div class="tag-wrap">
                ...
                <div class="search">
                    ...
                    <el-popover v-model="popoverVisible2" placement="right" trigger="manual" @click.native.stop="() => {}">
                        <div class="add-tag">
                            <div class="gray-900 mb-4">{{ opTitle }}</div>
                            ...
                            <div class="color-wrap mb-3">
                                <div v-for="item in colors" :key="item" class="rect" :style="{background: item}" @click="handleSelectColor(item)">
                                    <span v-if="item === tagColor" class="el-icon-check check"></span>
                                </div>
                            ...
                            <el-button :loading="loading" :disabled="!formInfo.name" type="primary" :size="config.renderConfig.layout.size" class="submit" @click="handleAddTag">确认添加</el-button>
                        </div>
                ...
                <!-- 标签列表 -->
                <div class="content">
                    <div v-for="(item, index) in matchedTagEnum" :key="index" class="item" :class="{active: currentSelectTag && item._id === currentSelectTag._id}">
