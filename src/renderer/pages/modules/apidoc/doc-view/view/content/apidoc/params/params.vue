...
<template>
    <div class="api-params" :class="{ vertical: layout === 'vertical' }">
        <div class="view-type" :class="{ vertical: layout === 'vertical' }">
            <div class="cursor-pointer" :class="{active: workMode === 'view'}" @click="toggleWorkMode('view')">预览</div>
            <el-divider direction="vertical"></el-divider>
            <div class="cursor-pointer mr-5" :class="{active: workMode === 'edit'}" @click="toggleWorkMode('edit')">编辑</div>
            <!-- <el-divider direction="vertical"></el-divider> -->
