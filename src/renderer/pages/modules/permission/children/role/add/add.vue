...
*/
<template>
    <s-dialog class="g-role" title="新增角色" :is-show="isShow" @close="handleClose">
        <div>
            <s-fieldset title="基本信息">
                <s-form ref="form" :form-info="formInfo">
                    <!-- eslint-disable-next-line vue/attribute-hyphenation -->
                    <s-form-item label="角色名称" vModel="roleName" required one-line></s-form-item>
                    <!-- eslint-disable-next-line vue/attribute-hyphenation -->
                    <s-form-item label="备注" vModel="remark" required one-line></s-form-item>
                </s-form>
            </s-fieldset>
