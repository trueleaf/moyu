...
*/
<template>
    <s-dialog :model-value="modelValue" top="10vh" title="新增菜单" @close="handleClose">
        <s-form ref="form">
        ...
        <template #footer>
            <el-button :loading="loading" size="mini" type="primary" @click="handleAddMenu">确定</el-button>
