...
import type { State as RootState, PermissionState } from '@types/store'
import { Response, PermissionUserInfo, PermissionClientMenu, PermissionClientRoute, GlobalConfig } from '@types/global'
